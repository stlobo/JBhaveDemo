...
public class TestBase {
	...
	private static final String executionType = APP_PROPERTY.getProperty("executionType");
	...
	public void beforeTest() throws Exception {
		try{
			...
			Browser browser = new Browser(
					...
					Platform.WINDOWS,APP_PROPERTY.getProperty("lang") );
			...
			LOGG.error("Error occured in Before Scenario method of the base class" + "Stacktrace : " + e);
			throw new Exception() ;
		}
	}
